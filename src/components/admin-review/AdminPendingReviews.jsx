...
const AdminPendingReviews = () => {
  ...
  const updateReviewStatus = async (reviewId, status) => {
    ...
    try {
      ...
      console.error("Error updating review status:", error.response || error.message);
      alert("Failed to update the review status. Please check your network and try again.");
    }
  };
                    ...
                    <div className="tooltip-wrapper">
                      {review.feedback.length > 30 ? (
                        <>
                          ...
                          <span className="tooltip-text">{review.feedback}</span>
                        </>
                      ) : (
                        review.feedback
                      )}
