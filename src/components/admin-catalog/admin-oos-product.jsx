...
const OOSProduct = () =>{
  ...
  const products = [
    ...
    { id: 2, name: 'Classic Chocolate Truffle Cake', size: '10x40', image: 'https://via.placeholder.com/100', quantity: 0, price: '163,000 VND' },
    { id: 3, name: 'Classic Chocolate Truffle Cake', size: '10x40', image: 'https://via.placeholder.com/100', quantity: 0, price: '163,000 VND' },
    { id: 4, name: 'Classic Chocolate Truffle Cake', size: '10x40', image: 'https://via.placeholder.com/100', quantity: 0, price: '163,000 VND' },
  ];
          ...
          <div>
            <div className="upper-title">
              <div className="profile-header1">
                ...
                <p>
                  <Link to="/dashboard">Home</Link> / Product / Out Of Stock Product
                </p>
              </div>
              <AvatarHeader />
            </div>
                ...
                {products.map((product, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      onClick={() => handleOpenModal(product.name)}>Restock</button>
                    </td>
                  </tr>
                ))}
              </tbody>
