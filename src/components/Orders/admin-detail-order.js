...
//                       displayData.productName.map((item, index) => (
//                         <tr key={item.id}>
//                           <td className="td">
//                             {index + 1 + currentPage * itemsPerPage}
//                           </td>
...
//                             {item} <br />
//                           </td>
//                           <td className="td">{item.price[index]}</td>
//                           <td className="td">{item.qty[index]}</td>
//                         </tr>
//                       ))}
//                   </tbody>
//                 </Table>
                ...
                <Table className="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="td">{details.orderDate}</td>
                      <td className="td">{details.approvedDate}</td>
                      <td className="td">{details.shippedDate}</td>
                      <td className="td">{details.arrivalDate}</td>
