...
//   //   try {
//   //     const response = await axios.post("http://localhost:8080/api/add/admin-product", formData, {
//   //       headers: {
...
//       (p) =>
//         p.categoryId === newProduct.categoryId && // Fix typo here
//         p.productName === newProduct.name && // Added check for product name
//         p.productItem.some((item) => item.size === newProduct.size)
//     );

//     if (existingProduct) {
//       // If a matching product exists, update the quantity of the existing product item
...
//       try {
//         // Update the product item quantity on the server
//         await axios.put(
...
//             qtyInStock: updatedQty, // Use the updated quantity
...
//       }
//     } else {
//       // If no matching product exists, create a new one
//       const formData = new FormData();
//       formData.append("categoryId", newProduct.categoryId);
//       formData.append("name", newProduct.name);
//       formData.append("description", newProduct.description);
...
//     setDesInfo({ ...newDesInfo, [e.target.value]: e.target.value });
//   };

//   const handleAddDesInfo = async (productId) => {
//     try {
//       await axios.post(
//         `http://localhost:8080/api/product/${productId}/add-desinfo`,
//         newDesInfo
//       );
//       console.log("Description info added successfully");
//       setDesInfo({ desTitleID: "", desInfo: "" });
//       handleClose2();
//     } catch (error) {
...
//                                       variant="success"
//                                       onClick={() =>
//                                         handleAddDesInfo(item.productId)
//                                       }
//                                     >
//                                       Add Description
//                                     </Button>
