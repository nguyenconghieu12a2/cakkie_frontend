...
const Profile = ({ onLogout }) => {
  ...
  const renderMainContent = () => {
    switch (activeComponent) {
      ...
      case "editProfile":
        return (
          <EditProfile profileData={profileData} onSave={handleSaveProfile} />
        );
      case "changePassword":
  ...
  if (errorMessage) {
    return (
      <div className="profile-page-error-message text-center mt-3">
        {errorMessage}
      </div>
    );
  }
  ...
  if (!profileData) {
    return (
      <div className="profile-page-loading-message text-center mt-3">
        Loading...
      </div>
    );
  }
  ...
  return (
    <div className="profile-page-layout">
      {renderSidebar()}
      <main className="profile-page-main-content">{renderMainContent()}</main>
    </div>
  );
};
